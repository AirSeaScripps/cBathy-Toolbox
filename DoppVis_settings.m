...
params.stationStr = 'COAST_2023';
params.dxm = 0.5;                    % analysis domain spacing in x
params.dym = 0.5;                    % analysis domain spacing in y
params.xyMinMax = [0 255 0 255];   % min, max of x, then y
