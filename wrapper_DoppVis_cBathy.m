...
elseif strcmp(mode,'cBathy')
    ...
    cubeName = 'DemoData/1447691340.Mon.Nov.16_16_29_00.GMT.2015.argus02b.cx.mBW.mat';
    ...
    load(cubeName) 
    % now load the params file and look at the params variable
    settings_file = 'argus02b';
else
    disp('I don''t know what mode we''re in. Please select either DoppVis or cBathy.')
end
